/* ============================================================
   ...
   ------------------------------------------------------------
   【この版(v167)でやること = STEP4】

   **まだ曲は繋ぎません。** 2枚のデッキを用意し、主役を交代できる
   ようにするところまでです。曲が終わったら次の曲へ、という動きは
   今までと変わりません。

   拍で繋ぐ(クロスフェード)のはSTEP5、画面ロック中に何曲繋がるかを
   数えるのはSTEP6、メインメニューも同じ仕組みに移すのはSTEP7です。
