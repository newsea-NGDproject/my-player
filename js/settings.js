...
/*
⚠️⚠️ **「未注入曲の時は設定を開けない」は入れません(v218で撤回)。**

v217で一度入れましたが、竹弘の判断で取りやめました(2026-09-21):

    「メインメニューで⚙️を開いて『🏃 ノリノリアシスト』は自由に
      設定してOKとします。つまりv216のまま。『🏃 ノリノリアシスト』の
      設定上部に、このノリノリアシストはノリノリRun再生の機能だよと
      謳ってますので。メインメニューで設定しても問題なし。
      メインメニューでは機能が働かないだけ」

**設定画面に「これは🕺ノリノリRun再生の機能です」と書いてあるので、
いつ設定しても迷わない**、というのが理由です。塞ぐ方がかえって
「なぜ押せないのか」を考えさせてしまいます。

→ **この項目は、どんな曲が鳴っていても自由に開けます。**
*/
